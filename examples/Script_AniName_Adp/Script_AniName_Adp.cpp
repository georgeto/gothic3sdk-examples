...
void GE_STDCALL UndeadAddon_GetAniName(bCString &p_RetString, eCEntity *p_Entity, gEAction p_Action, bCString p_Str1,
                                       bCString &p_Str2, GEBool p_Bool)
{
    Hook_UndeadAddon_GetAniName.GetOriginalFunction (&UndeadAddon_GetAniName)(p_RetString, p_Entity, p_Action, p_Str1,
                                                                              p_Str2, p_Bool);
...
void ApplyHooks()
{
    ...
    Hook_UndeadAddon_GetAniName.Hook(RVA_Game(0x16f840), &UndeadAddon_GetAniName, mCBaseHook::mEHookType_ThisCall);
