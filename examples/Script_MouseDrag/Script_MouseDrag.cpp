...
void ApplyHooks()
{
    ...
    */
    Hook_ListCtrl_ProcessMouseClickEvents.Hook(RVA_Gui(0x29800),
                                               ProcessMouseClickEvents<Hook_ListCtrl_ProcessMouseClickEvents>,
                                               mCBaseHook::mEHookType_ThisCall);
    Hook_MenuBar_ProcessMouseClickEvents.Hook(RVA_Gui(0x24AF0),
                                              ProcessMouseClickEvents<Hook_MenuBar_ProcessMouseClickEvents>,
                                              mCBaseHook::mEHookType_ThisCall);
}
