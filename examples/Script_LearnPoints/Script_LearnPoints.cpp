...
void LoadSettings()
{
    ...
    {
        g_iLearnPointsOnLevelUp =
            config.GetInt(bCString("Game"), bCString("Game.LearnPointsOnLevelUp"), g_iLearnPointsOnLevelUp);
        g_iHealthPointsOnLevelUp =
            config.GetInt(bCString("Game"), bCString("Game.HealthPointsOnLevelUp"), g_iHealthPointsOnLevelUp);
        g_iStaminaPointsOnLevelUp =
            config.GetInt(bCString("Game"), bCString("Game.StaminaPointsOnLevelUp"), g_iStaminaPointsOnLevelUp);
        g_iManaPointsOnLevelUp =
            config.GetInt(bCString("Game"), bCString("Game.ManaPointsOnLevelUp"), g_iManaPointsOnLevelUp);
    }
}
...
extern "C" __declspec(dllexport) gSScriptInit const *GE_STDCALL ScriptInit(void)
{
    ...
    Hook_GetIncrementedLearnPoints2.Hook(RVA_ScriptGame(0x4E76E), &GetIncrementedLearnPoints,
